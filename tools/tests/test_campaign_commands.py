...
class TestCampaignCommandAllowlist(unittest.TestCase):
    def test_all_canonical_commands_are_allowed(self):
        for command in (
            ...
            "run universe-audit ai-infrastructure",
            "run profile VRT",
    ...
    def test_shell_suffixes_are_rejected(self):
        for command in (
            ...
            "run universe-audit ai-infrastructure && run universe ai-infrastructure",
            "run universe-audit ai-infrastructure$(whoami)",
    ...
    def test_ids_and_case_are_exact(self):
        for command in (
            ...
            "run universe-audit AI-Infrastructure",
            "run universe-audit ../secrets",
            "run universe-audit ai-infrastructure extra",
            "run profile vrt",
            "run profile --campaign camp-20260829-01",
